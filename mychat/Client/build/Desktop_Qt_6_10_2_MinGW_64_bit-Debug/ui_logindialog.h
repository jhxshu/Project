...
public:
    ...
    void setupUi(QDialog *LoginDialog)
    {
        ...
        label->setPixmap(QPixmap(QString::fromUtf8(":/res/ico1.png")));
        ...
        btn = new QPushButton(LoginDialog);
        btn->setObjectName("btn");
        btn->setMinimumSize(QSize(100, 30));
        btn->setMaximumSize(QSize(100, 30));

        horizontalLayout_4->addWidget(btn);
    ...
    void retranslateUi(QDialog *LoginDialog)
    {
        ...
        btn->setText(QCoreApplication::translate("LoginDialog", "\347\231\273\345\275\225", nullptr));
